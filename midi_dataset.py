...
def create_sequences(tokens: List[str], sequence_length: int) -> List[List[str]]:
    sequences = []
    for i in range(0, len(tokens) - sequence_length, 3):
        sequence = tokens[i:i + sequence_length + 1]
...
class MIDIDataset(Dataset):
    def __init__(self,
        ...
        self.max_interval_jump = 12  # max jump between notes
